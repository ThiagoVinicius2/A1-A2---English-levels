...
const TRANS_DECKS = {
  comprehension:  { label: "Comprehension Practice",    tag: "Deck 1" },
  vocab1:         { label: "Vocab Rocket (Part I)",     tag: "Deck 2" },
  vocab2:         { label: "Vocab Rocket (Part II)",    tag: "Deck 3" },
  immersion:      { label: "Immersion Time",            tag: "Deck 4" },
  grammar1:       { label: "Grammar Hacks 01",          tag: "Deck 5" },
  grammar2:       { label: "Grammar Hacks 02",          tag: "Deck 6" },
  pronunciation:  { label: "Pronunciation Hacks",       tag: "Deck 7" },
};
